...
def detect_red(img, Threshold=0.01):
    ...
    img = cv.resize(np.array(img), desired_dim, interpolation=cv.INTER_LINEAR)
...
displayimage = pygame.image.load(r'C:\Users\Admin\Desktop\New folder (3)\test_images\img_1.jpg')
while True:
